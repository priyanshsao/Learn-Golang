...
func CreateTemplateCache() (map[string]*template.Template, error) {
	...
	// get all of the files named *.page.tmpl from ./day-27/templates
	pages, err := filepath.Glob("D:/golang series/Learn-Golang/day-27/templates/*.page.tmpl")
	if err != nil {
		return myCache, err
	}
	...
	for _, page := range pages {
		...
		matching, err := filepath.Glob("D:/golang series/Learn-Golang/day-27/templates/*.layout.tmpl")
		if err != nil {
			return myCache, err
		}
		...
		*/
		if len(matching) > 0 {
			ts, err = ts.ParseGlob("D:/golang series/Learn-Golang/day-27/templates/*.layout.tmpl")
			if err != nil {
				return myCache, err
			}
		}
