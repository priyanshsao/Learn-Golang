...
func RenderTemplates(w http.ResponseWriter, tmpl string) {
	...
	*/
	parsedTemplate, err := template.ParseFiles("D:/golang series/Learn-Golang/day-18/templates/" + tmpl, "D:/golang series/Learn-Golang/day-18/templates/base.layout.tmpl")
	if err != nil {
