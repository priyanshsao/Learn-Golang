...
func CreateTemplateCache() (map[string]*template.Template, error) {
	...
	pages, err := filepath.Glob("D:/golang series/Learn-Golang/day-21/templates/*.page.tmpl")
	if err != nil {
		return myCache, err
	}
	...
	for _, page := range pages {
		...
		matching, err := filepath.Glob("D:/golang series/Learn-Golang/day-21/templates/*.layout.tmpl")
		if err != nil {
			return myCache, err
		}
		...
		*/
		if len(matching) > 0 {
			ts, err = ts.ParseGlob("D:/golang series/Learn-Golang/day-21/templates/*.layout.tmpl")
			if err != nil {
				return myCache, err
			}
		}
