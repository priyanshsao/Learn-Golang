...
import (
	...
	"github.com/Learn-Golang/modules/day-22/pkg/models"
)
...
func CreateTemplateCache() (map[string]*template.Template, error) {
	...
	// get all of the files named *.page.tmpl from ./day-22/templates
	pages, err := filepath.Glob("D:/golang series/Learn-Golang/day-22/templates/*.page.tmpl")
	if err != nil {
		return myCache, err
	}
	...
	for _, page := range pages {
		...
		matching, err := filepath.Glob("D:/golang series/Learn-Golang/day-22/templates/*.layout.tmpl")
		if err != nil {
			return myCache, err
		}
		...
		*/
		if len(matching) > 0 {
			ts, err = ts.ParseGlob("D:/golang series/Learn-Golang/day-22/templates/*.layout.tmpl")
			if err != nil {
				return myCache, err
			}
		}
